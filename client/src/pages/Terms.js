...
import { Container, Typography, Box, Paper, List, ListItem, Button } from '@mui/material';
    ...
    <Container maxWidth="md" sx={{ py: 4 }}>
      <Box sx={{ mb: 2 }}>
        <Button
          ...
          onClick={() => navigate(-1)}
          sx={{ color: '#a855f7', textTransform: 'none' }}
        >
          Volver
        </Button>
      </Box>
      <Paper sx={{ p: 4, backgroundColor: 'rgba(15, 23, 42, 0.95)', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
        ...
        <Typography variant="body1" paragraph sx={{ color: '#e5e7eb' }}>
          Bienvenido a Ghost League. Al usar nuestros servicios, aceptas los siguientes términos y condiciones.
        </Typography>
